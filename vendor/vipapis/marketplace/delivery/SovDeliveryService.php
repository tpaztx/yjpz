...
interface SovDeliveryServiceIf{
	...
	public function encrypt(\vipapis\marketplace\delivery\EncryptRequest $request);
...
class _SovDeliveryServiceClient extends \Osp\Base\OspStub implements \vipapis\marketplace\delivery\SovDeliveryServiceIf{
	...
	public function encrypt(\vipapis\marketplace\delivery\EncryptRequest $request){
		...
		$this->send_encrypt( $request);
		return $this->recv_encrypt();
	}
	
	public function send_encrypt(\vipapis\marketplace\delivery\EncryptRequest $request){
		
		$this->initInvocation("encrypt");
		$args = new \vipapis\marketplace\delivery\SovDeliveryService_encrypt_args();
	...
	public function recv_encrypt(){
		...
		$result = new \vipapis\marketplace\delivery\SovDeliveryService_encrypt_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class SovDeliveryService_encrypt_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \vipapis\marketplace\delivery\EncryptRequest();
			$this->request->read($input);
...
class SovDeliveryService_encrypt_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\marketplace\delivery\EncryptResponse();
			$this->success->read($input);
