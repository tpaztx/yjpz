...
class ReceivingOrderInfo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['order_receiving_date'])){
				
				$this->order_receiving_date = $vals['order_receiving_date'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("order_receiving_date" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->order_receiving_date);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('order_receiving_date');
		$xfer += $output->writeString($this->order_receiving_date);
