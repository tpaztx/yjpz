...
class InventoryAdjustRsp {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['totalSuccessQty'])){
				
				$this->totalSuccessQty = $vals['totalSuccessQty'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("totalSuccessQty" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->totalSuccessQty); 
	...
	public function write($output){
		...
		if($this->totalSuccessQty !== null) {
			
			$xfer += $output->writeFieldBegin('totalSuccessQty');
			$xfer += $output->writeI32($this->totalSuccessQty);
