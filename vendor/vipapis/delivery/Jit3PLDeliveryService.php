...
interface Jit3PLDeliveryServiceIf{
	...
	public function cancelDelivery(\vipapis\delivery\Cancel3PLDeliveryReq $cancelDeliveryReq);
	...
	public function createPoDeliveryV2(\vipapis\delivery\Create3PLPoDeliveryReq $req);
	...
	public function editPoDeliveryV2(\vipapis\delivery\Edit3PLDeliveryReq $editDeliveryReq);
...
class _Jit3PLDeliveryServiceClient extends \Osp\Base\OspStub implements \vipapis\delivery\Jit3PLDeliveryServiceIf{
	...
	public function send_cancelDelivery(\vipapis\delivery\Cancel3PLDeliveryReq $cancelDeliveryReq){
		
		$this->initInvocation("cancelDelivery");
		$args = new \vipapis\delivery\Jit3PLDeliveryService_cancelDelivery_args();
	...
	public function recv_cancelDelivery(){
		...
		$result = new \vipapis\delivery\Jit3PLDeliveryService_cancelDelivery_result();
	...
	public function createPoDeliveryV2(\vipapis\delivery\Create3PLPoDeliveryReq $req){
		...
		$this->send_createPoDeliveryV2( $req);
		return $this->recv_createPoDeliveryV2();
	}
	
	public function send_createPoDeliveryV2(\vipapis\delivery\Create3PLPoDeliveryReq $req){
		
		$this->initInvocation("createPoDeliveryV2");
		$args = new \vipapis\delivery\Jit3PLDeliveryService_createPoDeliveryV2_args();
	...
	public function recv_createPoDeliveryV2(){
		...
		$result = new \vipapis\delivery\Jit3PLDeliveryService_createPoDeliveryV2_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_editPoDeliveryV2(\vipapis\delivery\Edit3PLDeliveryReq $editDeliveryReq){
		
		$this->initInvocation("editPoDeliveryV2");
		$args = new \vipapis\delivery\Jit3PLDeliveryService_editPoDeliveryV2_args();
	...
	public function recv_editPoDeliveryV2(){
		...
		$result = new \vipapis\delivery\Jit3PLDeliveryService_editPoDeliveryV2_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class Jit3PLDeliveryService_cancelDelivery_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->cancelDeliveryReq = new \vipapis\delivery\Cancel3PLDeliveryReq();
...
class Jit3PLDeliveryService_createPoDeliveryV2_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \vipapis\delivery\Create3PLPoDeliveryReq();
			$this->req->read($input);
...
class Jit3PLDeliveryService_editPoDeliveryV2_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->editDeliveryReq = new \vipapis\delivery\Edit3PLDeliveryReq();
...
class Jit3PLDeliveryService_cancelDelivery_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\delivery\Cancel3PLDeliveryResp();
...
class Jit3PLDeliveryService_createPoDeliveryV2_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\delivery\Create3PLPoDeliveryResponse();
			$this->success->read($input);
...
class Jit3PLDeliveryService_editPoDeliveryV2_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\delivery\Edit3PLDeliveryResp();
			$this->success->read($input);
