...
interface DeliveryOrderServiceIf{
	...
	public function allowCancelTmsOrder(\com\vip\top\deliveryorder\bizservice\AllowCancelTmsOrderRequest $allowCancelTmsOrderRequest);
	...
	public function getBindedTransportNos(\com\vip\top\deliveryorder\bizservice\GetBindedTransportNosRequest $req);
...
class _DeliveryOrderServiceClient extends \Osp\Base\OspStub implements \com\vip\top\deliveryorder\bizservice\DeliveryOrderServiceIf{
	...
	public function allowCancelTmsOrder(\com\vip\top\deliveryorder\bizservice\AllowCancelTmsOrderRequest $allowCancelTmsOrderRequest){
		...
		$this->send_allowCancelTmsOrder( $allowCancelTmsOrderRequest);
		return $this->recv_allowCancelTmsOrder();
	}
	
	public function send_allowCancelTmsOrder(\com\vip\top\deliveryorder\bizservice\AllowCancelTmsOrderRequest $allowCancelTmsOrderRequest){
		
		$this->initInvocation("allowCancelTmsOrder");
		$args = new \com\vip\top\deliveryorder\bizservice\DeliveryOrderService_allowCancelTmsOrder_args();
		
		$args->allowCancelTmsOrderRequest = $allowCancelTmsOrderRequest;
		
		$this->send_base($args);
	}
	
	public function recv_allowCancelTmsOrder(){
		
		$result = new \com\vip\top\deliveryorder\bizservice\DeliveryOrderService_allowCancelTmsOrder_result();
	...
	public function getBindedTransportNos(\com\vip\top\deliveryorder\bizservice\GetBindedTransportNosRequest $req){
		...
		$this->send_getBindedTransportNos( $req);
		return $this->recv_getBindedTransportNos();
	}
	
	public function send_getBindedTransportNos(\com\vip\top\deliveryorder\bizservice\GetBindedTransportNosRequest $req){
		
		$this->initInvocation("getBindedTransportNos");
		$args = new \com\vip\top\deliveryorder\bizservice\DeliveryOrderService_getBindedTransportNos_args();
	...
	public function recv_getBindedTransportNos(){
		
		$result = new \com\vip\top\deliveryorder\bizservice\DeliveryOrderService_getBindedTransportNos_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class DeliveryOrderService_allowCancelTmsOrder_args {
	
	static $_TSPEC;
	public $allowCancelTmsOrderRequest = null;
	...
	public function __construct($vals=null){
		...
		if (!isset(self::$_TSPEC)){
			...
			self::$_TSPEC = array(
			1 => array(
			'var' => 'allowCancelTmsOrderRequest'
			),
		...
		if (is_array($vals)){
			...
			if (isset($vals['allowCancelTmsOrderRequest'])){
				
				$this->allowCancelTmsOrderRequest = $vals['allowCancelTmsOrderRequest'];
			}
	...
	public function read($input){
		...
		if(true) {
			...
			$this->allowCancelTmsOrderRequest = new \com\vip\top\deliveryorder\bizservice\AllowCancelTmsOrderRequest();
			$this->allowCancelTmsOrderRequest->read($input);
	...
	public function write($output){
		...
		if($this->allowCancelTmsOrderRequest !== null) {
			
			$xfer += $output->writeFieldBegin('allowCancelTmsOrderRequest');
			
			if (!is_object($this->allowCancelTmsOrderRequest)) {
				
				throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
			}
			
			$xfer += $this->allowCancelTmsOrderRequest->write($output);
...
class DeliveryOrderService_getBindedTransportNos_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\top\deliveryorder\bizservice\GetBindedTransportNosRequest();
			$this->req->read($input);
...
class DeliveryOrderService_allowCancelTmsOrder_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\deliveryorder\bizservice\AllowCancelTmsOrderResponse();
...
class DeliveryOrderService_getBindedTransportNos_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\deliveryorder\bizservice\GetBindedTransportNosResponse();
			$this->success->read($input);
