...
class CategoryAPIClient{
	...
	public static function getService(){
		...
		if (! CategoryAPIClient::$isRegis){
			
			CategoryAPIClient::regis ();
			CategoryAPIClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CategoryAPIClient::$DEFAULT_PROXY_IP;
		$port = CategoryAPIClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\osp\category\api\comm\CategoryAPIHelper();
	}
