...
interface PmsDataServiceIf{
	...
	public function publishResumeUserCouponMsg(\com\vip\pms\data\service\ResumeUserCouponReqModel $reqModel);
	
	public function publishReturnPromotionMsg(\com\vip\pms\data\service\ReturnPromotionReqModel $reqModel);
	...
	public function queryGoodsInfoByActivityNo( $activityNo, $offset, $pageSize);
...
class _PmsDataServiceClient extends \Osp\Base\OspStub implements \com\vip\pms\data\service\PmsDataServiceIf{
	...
	public function publishResumeUserCouponMsg(\com\vip\pms\data\service\ResumeUserCouponReqModel $reqModel){
		...
		$this->send_publishResumeUserCouponMsg( $reqModel);
		return $this->recv_publishResumeUserCouponMsg();
	}
	
	public function send_publishResumeUserCouponMsg(\com\vip\pms\data\service\ResumeUserCouponReqModel $reqModel){
		
		$this->initInvocation("publishResumeUserCouponMsg");
		$args = new \com\vip\pms\data\service\PmsDataService_publishResumeUserCouponMsg_args();
	...
	public function recv_publishResumeUserCouponMsg(){
		
		$result = new \com\vip\pms\data\service\PmsDataService_publishResumeUserCouponMsg_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function publishReturnPromotionMsg(\com\vip\pms\data\service\ReturnPromotionReqModel $reqModel){
		...
		$this->send_publishReturnPromotionMsg( $reqModel);
		return $this->recv_publishReturnPromotionMsg();
	}
	
	public function send_publishReturnPromotionMsg(\com\vip\pms\data\service\ReturnPromotionReqModel $reqModel){
		
		$this->initInvocation("publishReturnPromotionMsg");
		$args = new \com\vip\pms\data\service\PmsDataService_publishReturnPromotionMsg_args();
	...
	public function recv_publishReturnPromotionMsg(){
		
		$result = new \com\vip\pms\data\service\PmsDataService_publishReturnPromotionMsg_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryGoodsInfoByActivityNo( $activityNo, $offset, $pageSize){
		...
		$this->send_queryGoodsInfoByActivityNo( $activityNo, $offset, $pageSize);
		return $this->recv_queryGoodsInfoByActivityNo();
	}
	
	public function send_queryGoodsInfoByActivityNo( $activityNo, $offset, $pageSize){
		
		$this->initInvocation("queryGoodsInfoByActivityNo");
		$args = new \com\vip\pms\data\service\PmsDataService_queryGoodsInfoByActivityNo_args();
		
		$args->activityNo = $activityNo;
	...
	public function recv_queryGoodsInfoByActivityNo(){
		
		$result = new \com\vip\pms\data\service\PmsDataService_queryGoodsInfoByActivityNo_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class PmsDataService_publishResumeUserCouponMsg_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->reqModel = new \com\vip\pms\data\service\ResumeUserCouponReqModel();
...
class PmsDataService_publishReturnPromotionMsg_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->reqModel = new \com\vip\pms\data\service\ReturnPromotionReqModel();
			$this->reqModel->read($input);
...
class PmsDataService_queryGoodsInfoByActivityNo_args {
...
class PmsDataService_publishResumeUserCouponMsg_result {
...
class PmsDataService_publishReturnPromotionMsg_result {
...
class PmsDataService_queryGoodsInfoByActivityNo_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\pms\data\service\ActivityGoodsInfoResponse();
			$this->success->read($input);
