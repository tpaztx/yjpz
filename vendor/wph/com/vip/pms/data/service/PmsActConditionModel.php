...
class PmsActConditionModel {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['ticketTimeLimit'])){
				
				$this->ticketTimeLimit = $vals['ticketTimeLimit'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("ticketTimeLimit" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->ticketTimeLimit); 
	...
	public function write($output){
		...
		if($this->ticketTimeLimit !== null) {
			...
			$xfer += $output->writeFieldBegin('ticketTimeLimit');
			$xfer += $output->writeI32($this->ticketTimeLimit);
