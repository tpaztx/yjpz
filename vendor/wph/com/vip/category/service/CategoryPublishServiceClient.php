...
class CategoryPublishServiceClient{
	...
	public static function getService(){
		...
		if (! CategoryPublishServiceClient::$isRegis){
			
			CategoryPublishServiceClient::regis ();
			CategoryPublishServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CategoryPublishServiceClient::$DEFAULT_PROXY_IP;
		$port = CategoryPublishServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\category\service\CategoryPublishServiceHelper();
	}
