...
class BipDiagramServiceClient{
	...
	public static function getService(){
		...
		if (! BipDiagramServiceClient::$isRegis){
			
			BipDiagramServiceClient::regis ();
			BipDiagramServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = BipDiagramServiceClient::$DEFAULT_PROXY_IP;
		$port = BipDiagramServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\bip\report\service\BipDiagramServiceHelper();
	}
