...
class UnionPromotionMaterialServiceClient{
	...
	public static function getService(){
		...
		if (! UnionPromotionMaterialServiceClient::$isRegis){
			
			UnionPromotionMaterialServiceClient::regis ();
			UnionPromotionMaterialServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = UnionPromotionMaterialServiceClient::$DEFAULT_PROXY_IP;
		$port = UnionPromotionMaterialServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\adp\api\open\service\UnionPromotionMaterialServiceHelper();
	}
