...
class WmsPoHeader {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['bizTags'])){
				
				$this->bizTags = $vals['bizTags'];
			}
	...
	public function write($output){
		...
		if($this->bizTags !== null) {
			...
			$xfer += $output->writeFieldBegin('bizTags');
