...
class RbpBaseConfig4OutletsServiceClient{
	...
	public static function getService(){
		...
		if (! RbpBaseConfig4OutletsServiceClient::$isRegis){
			
			RbpBaseConfig4OutletsServiceClient::regis ();
			RbpBaseConfig4OutletsServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = RbpBaseConfig4OutletsServiceClient::$DEFAULT_PROXY_IP;
		$port = RbpBaseConfig4OutletsServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\rbp\service\RbpBaseConfig4OutletsServiceHelper();
	}
