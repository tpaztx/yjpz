...
class ApVendorServiceClient{
	...
	public static function getService(){
		...
		if (! ApVendorServiceClient::$isRegis){
			
			ApVendorServiceClient::regis ();
			ApVendorServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ApVendorServiceClient::$DEFAULT_PROXY_IP;
		$port = ApVendorServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\ebs\ap\service\ApVendorServiceHelper();
	}
