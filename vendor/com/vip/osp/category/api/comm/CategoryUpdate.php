...
class CategoryUpdate {
	...
	public function read($input){
		...
		while(true){
			...
			if ("updateType" == $schemeField){
				...
				$names = \com\vip\osp\category\api\comm\UpdateType::$__names;
				$name = null;
			...
			if ("category" == $schemeField){
				...
				$this->category = new \com\vip\osp\category\api\comm\Category();
	...
	public function write($output){
		...
		$em = new \com\vip\osp\category\api\comm\UpdateType; 
