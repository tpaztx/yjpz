...
class HierarchyCategoryIds {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['pathList'])){
				
				$this->pathList = $vals['pathList'];
			}
			...
			if ("pathList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\osp\category\api\comm\BriefCategoryPath();
						$elem1->read($input);
						
						$this->pathList[$_size1++] = $elem1;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		if($this->pathList !== null) {
			...
			$xfer += $output->writeFieldBegin('pathList');
			...
			foreach ($this->pathList as $iter0){
