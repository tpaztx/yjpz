...
interface PurchaseOrderServiceIf{
	...
	public function batchUpdatePurchaseOrderRefundTime(\com\vip\xstore\cc\bulkbuying\service\BatchUpdatePurchaseOrderRefundTime $request);
...
class _PurchaseOrderServiceClient extends \Osp\Base\OspStub implements \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderServiceIf{
	...
	public function batchUpdatePurchaseOrderRefundTime(\com\vip\xstore\cc\bulkbuying\service\BatchUpdatePurchaseOrderRefundTime $request){
		...
		$this->send_batchUpdatePurchaseOrderRefundTime( $request);
		return $this->recv_batchUpdatePurchaseOrderRefundTime();
	}
	
	public function send_batchUpdatePurchaseOrderRefundTime(\com\vip\xstore\cc\bulkbuying\service\BatchUpdatePurchaseOrderRefundTime $request){
		
		$this->initInvocation("batchUpdatePurchaseOrderRefundTime");
		$args = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_batchUpdatePurchaseOrderRefundTime_args();
	...
	public function recv_batchUpdatePurchaseOrderRefundTime(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_batchUpdatePurchaseOrderRefundTime_result();
...
class PurchaseOrderService_batchUpdatePurchaseOrderRefundTime_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\xstore\cc\bulkbuying\service\BatchUpdatePurchaseOrderRefundTime();
...
class PurchaseOrderService_batchUpdatePurchaseOrderRefundTime_result {
