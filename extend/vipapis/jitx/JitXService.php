...
interface JitXServiceIf{
	...
	public function applyWarehouse(\vipapis\jitx\ApplyWarehouseRequest $req);
	...
	public function orderReceiving(\vipapis\jitx\OrderReceivingRequest $req);
	
	public function queryApplyWarehouseResult(\vipapis\jitx\QueryApplyWarehouseResultRequest $req);
...
class _JitXServiceClient extends \Osp\Base\OspStub implements \vipapis\jitx\JitXServiceIf{
	...
	public function applyWarehouse(\vipapis\jitx\ApplyWarehouseRequest $req){
		...
		$this->send_applyWarehouse( $req);
		return $this->recv_applyWarehouse();
	}
	
	public function send_applyWarehouse(\vipapis\jitx\ApplyWarehouseRequest $req){
		
		$this->initInvocation("applyWarehouse");
		$args = new \vipapis\jitx\JitXService_applyWarehouse_args();
	...
	public function recv_applyWarehouse(){
		
		$result = new \vipapis\jitx\JitXService_applyWarehouse_result();
	...
	public function orderReceiving(\vipapis\jitx\OrderReceivingRequest $req){
		...
		$this->send_orderReceiving( $req);
		return $this->recv_orderReceiving();
	}
	
	public function send_orderReceiving(\vipapis\jitx\OrderReceivingRequest $req){
		
		$this->initInvocation("orderReceiving");
		$args = new \vipapis\jitx\JitXService_orderReceiving_args();
	...
	public function recv_orderReceiving(){
		
		$result = new \vipapis\jitx\JitXService_orderReceiving_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryApplyWarehouseResult(\vipapis\jitx\QueryApplyWarehouseResultRequest $req){
		...
		$this->send_queryApplyWarehouseResult( $req);
		return $this->recv_queryApplyWarehouseResult();
	}
	
	public function send_queryApplyWarehouseResult(\vipapis\jitx\QueryApplyWarehouseResultRequest $req){
		
		$this->initInvocation("queryApplyWarehouseResult");
		$args = new \vipapis\jitx\JitXService_queryApplyWarehouseResult_args();
	...
	public function recv_queryApplyWarehouseResult(){
		
		$result = new \vipapis\jitx\JitXService_queryApplyWarehouseResult_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class JitXService_applyWarehouse_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \vipapis\jitx\ApplyWarehouseRequest();
			$this->req->read($input);
...
class JitXService_orderReceiving_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \vipapis\jitx\OrderReceivingRequest();
			$this->req->read($input);
...
class JitXService_queryApplyWarehouseResult_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \vipapis\jitx\QueryApplyWarehouseResultRequest();
			$this->req->read($input);
...
class JitXService_applyWarehouse_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\jitx\ApplyWarehouseResponse();
...
class JitXService_orderReceiving_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\jitx\OrderReceivingResponse();
			$this->success->read($input);
...
class JitXService_queryApplyWarehouseResult_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\jitx\QueryApplyWarehouseResultResponse();
			$this->success->read($input);
