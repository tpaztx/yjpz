...
class CustomsClearanceServiceClient{
	...
	public static function getService(){
		...
		if (! CustomsClearanceServiceClient::$isRegis){
			
			CustomsClearanceServiceClient::regis ();
			CustomsClearanceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CustomsClearanceServiceClient::$DEFAULT_PROXY_IP;
		$port = CustomsClearanceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\cup\customs\CustomsClearanceServiceHelper();
	}
