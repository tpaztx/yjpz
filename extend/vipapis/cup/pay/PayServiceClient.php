...
class PayServiceClient{
	...
	public static function getService(){
		...
		if (! PayServiceClient::$isRegis){
			
			PayServiceClient::regis ();
			PayServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = PayServiceClient::$DEFAULT_PROXY_IP;
		$port = PayServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\cup\pay\PayServiceHelper();
	}
