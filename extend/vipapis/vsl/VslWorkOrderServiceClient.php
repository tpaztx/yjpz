...
class VslWorkOrderServiceClient{
	...
	public static function getService(){
		...
		if (! VslWorkOrderServiceClient::$isRegis){
			
			VslWorkOrderServiceClient::regis ();
			VslWorkOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VslWorkOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = VslWorkOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\vsl\VslWorkOrderServiceHelper();
	}
