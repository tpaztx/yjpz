...
class QueryInstructionsResponse {
	...
	public function getName(){
		...
		return 'QueryInstructionsResponse';
	}
			...
			if ("instructions" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \vipapis\vsl\Instruction();
						$elem0->read($input);
						
						$this->instructions[$_size0++] = $elem0;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		if($this->instructions !== null) {
			...
			$xfer += $output->writeFieldBegin('instructions');
			...
			foreach ($this->instructions as $iter0){
