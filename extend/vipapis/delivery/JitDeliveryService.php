...
interface JitDeliveryServiceIf{
	...
	public function confirmDelivery( $vendor_id, $storage_no, $po_no, $store_sn, $operator_id);
...
class _JitDeliveryServiceClient extends \Osp\Base\OspStub implements \vipapis\delivery\JitDeliveryServiceIf{
	...
	public function confirmDelivery( $vendor_id, $storage_no, $po_no, $store_sn, $operator_id){
		...
		$this->send_confirmDelivery( $vendor_id, $storage_no, $po_no, $store_sn, $operator_id);
		return $this->recv_confirmDelivery();
	}
	
	public function send_confirmDelivery( $vendor_id, $storage_no, $po_no, $store_sn, $operator_id){
