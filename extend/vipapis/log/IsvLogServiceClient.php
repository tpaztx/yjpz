...
class IsvLogServiceClient{
	...
	public static function getService(){
		...
		if (! IsvLogServiceClient::$isRegis){
			
			IsvLogServiceClient::regis ();
			IsvLogServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = IsvLogServiceClient::$DEFAULT_PROXY_IP;
		$port = IsvLogServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\log\IsvLogServiceHelper();
	}
