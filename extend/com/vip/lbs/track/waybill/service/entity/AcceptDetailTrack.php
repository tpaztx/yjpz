...
class AcceptDetailTrack {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['trackSource'])){
				
				$this->trackSource = $vals['trackSource'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("trackSource" == $schemeField){
				
				$needSkip = false;
				$input->readByte($this->trackSource); 
	...
	public function write($output){
		...
		if($this->trackSource !== null) {
			...
			$xfer += $output->writeFieldBegin('trackSource');
			$xfer += $output->writeByte($this->trackSource);
