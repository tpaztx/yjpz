...
interface ReceivingServiceIf{
	...
	public function queryOverReasons();
...
class _ReceivingServiceClient extends \Osp\Base\OspStub implements \com\vip\xstore\pda\order\receiving\ReceivingServiceIf{
	...
	public function queryOverReasons(){
		...
		$this->send_queryOverReasons();
		return $this->recv_queryOverReasons();
	}
	
	public function send_queryOverReasons(){
		
		$this->initInvocation("queryOverReasons");
		$args = new \com\vip\xstore\pda\order\receiving\ReceivingService_queryOverReasons_args();
		
		$this->send_base($args);
	}
	
	public function recv_queryOverReasons(){
		
		$result = new \com\vip\xstore\pda\order\receiving\ReceivingService_queryOverReasons_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class ReceivingService_queryOverReasons_args {
...
class ReceivingService_queryOverReasons_result {
