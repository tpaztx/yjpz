...
class CcPo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['isRefundApproach'])){
				
				$this->isRefundApproach = $vals['isRefundApproach'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("isRefundApproach" == $schemeField){
				
				$needSkip = false;
				$input->readBool($this->isRefundApproach);
	...
	public function write($output){
		...
		if($this->isRefundApproach !== null) {
			
			$xfer += $output->writeFieldBegin('isRefundApproach');
			$xfer += $output->writeBool($this->isRefundApproach);
