...
class PoServiceClient{
	...
	public static function getService(){
		...
		if (! PoServiceClient::$isRegis){
			
			PoServiceClient::regis ();
			PoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = PoServiceClient::$DEFAULT_PROXY_IP;
		$port = PoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\venus\po\service\PoServiceHelper();
	}
