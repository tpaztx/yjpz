...
class ProductChangeServiceClient{
	...
	public static function getService(){
		...
		if (! ProductChangeServiceClient::$isRegis){
			
			ProductChangeServiceClient::regis ();
			ProductChangeServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProductChangeServiceClient::$DEFAULT_PROXY_IP;
		$port = ProductChangeServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\product\change\service\ProductChangeServiceHelper();
	}
