...
interface CarrierServiceIf{
	...
	public function getCarrierByScene( $sceneCode);
	...
	public function getReturnCarriersByAreaId(\com\vip\top\carrier\bizservice\GetReturnCarriersByAreaIdRequest $request);
...
class _CarrierServiceClient extends \Osp\Base\OspStub implements \com\vip\top\carrier\bizservice\CarrierServiceIf{
	...
	public function getCarrierByScene( $sceneCode){
		...
		$this->send_getCarrierByScene( $sceneCode);
		return $this->recv_getCarrierByScene();
	}
	
	public function send_getCarrierByScene( $sceneCode){
		
		$this->initInvocation("getCarrierByScene");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getCarrierByScene_args();
		
		$args->sceneCode = $sceneCode;
		
		$this->send_base($args);
	}
	
	public function recv_getCarrierByScene(){
		
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getCarrierByScene_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getReturnCarriersByAreaId(\com\vip\top\carrier\bizservice\GetReturnCarriersByAreaIdRequest $request){
		...
		$this->send_getReturnCarriersByAreaId( $request);
		return $this->recv_getReturnCarriersByAreaId();
	}
	
	public function send_getReturnCarriersByAreaId(\com\vip\top\carrier\bizservice\GetReturnCarriersByAreaIdRequest $request){
		
		$this->initInvocation("getReturnCarriersByAreaId");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getReturnCarriersByAreaId_args();
	...
	public function recv_getReturnCarriersByAreaId(){
		
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getReturnCarriersByAreaId_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class CarrierService_getCarrierByScene_args {
	
	static $_TSPEC;
	public $sceneCode = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['sceneCode'])){
				
				$this->sceneCode = $vals['sceneCode'];
			}
	...
	public function read($input){
		...
		if(true) {
			...
			$input->readString($this->sceneCode);
	...
	public function write($output){
		...
		if($this->sceneCode !== null) {
			...
			$xfer += $output->writeFieldBegin('sceneCode');
			$xfer += $output->writeString($this->sceneCode);
...
class CarrierService_getReturnCarriersByAreaId_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\top\carrier\bizservice\GetReturnCarriersByAreaIdRequest();
...
class CarrierService_getCarrierByScene_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem0 = new \com\vip\top\carrier\bizservice\CarrierSimpleModel();
					$elem0->read($input);
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem1 = new \com\vip\top\carrier\bizservice\RegisteredCarrierModelModel();
					$elem1->read($input);
...
class CarrierService_getReturnCarriersByAreaId_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\carrier\bizservice\GetReturnCarriersByAreaIdResponse();
			$this->success->read($input);
