...
class DataSyncServiceClient{
	...
	public static function getService(){
		...
		if (! DataSyncServiceClient::$isRegis){
			
			DataSyncServiceClient::regis ();
			DataSyncServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = DataSyncServiceClient::$DEFAULT_PROXY_IP;
		$port = DataSyncServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\collection\batch\service\datasync\DataSyncServiceHelper();
	}
