...
class ShipmentServiceClient{
	...
	public static function getService(){
		...
		if (! ShipmentServiceClient::$isRegis){
			
			ShipmentServiceClient::regis ();
			ShipmentServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ShipmentServiceClient::$DEFAULT_PROXY_IP;
		$port = ShipmentServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\prp\shipment\service\ShipmentServiceHelper();
	}
