...
class GlVoucherServiceClient{
	...
	public static function getService(){
		...
		if (! GlVoucherServiceClient::$isRegis){
			
			GlVoucherServiceClient::regis ();
			GlVoucherServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = GlVoucherServiceClient::$DEFAULT_PROXY_IP;
		$port = GlVoucherServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\ebs\gl\service\GlVoucherServiceHelper();
	}
